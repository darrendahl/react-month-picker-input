...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return MonthFormat; });
...
var Translator = /** @class */ (function () {
    ...
    Translator.prototype.monthName = function (name) {
        if (this.i18n.monthFormat === __WEBPACK_IMPORTED_MODULE_0__i18n__["c" /* MonthFormat */].SHORT) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DEFAULT_I18N", function() { return DEFAULT_I18N; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_react_input_mask__ = __webpack_require__(4);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__calendar__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__utils__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__i18n__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Translator__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__styles_index_css__ = __webpack_require__(14);
...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "DateFormat", function() { return __WEBPACK_IMPORTED_MODULE_4__i18n__["b"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "MonthFormat", function() { return __WEBPACK_IMPORTED_MODULE_4__i18n__["c"]; });
    ...
    function MonthPickerInput(props) {
        ...
        _this.valuesToMask = function (month, year) {
            if (typeof year == 'number' && typeof month == 'number') {
                return Object(__WEBPACK_IMPORTED_MODULE_3__utils__["b" /* valuesToMask */])(month, year, _this.t);
            }
            else
                return '';
        };
        ...
        _this.calendar = function () {
            ...
            return (__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", { style: { position: 'relative' } },
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__calendar__["a" /* default */], { year: year, month: month, onChange: _this.onCalendarChange, onOutsideClick: _this.onCalendarOutsideClick, translator: _this.t })));
        };
        ...
        _this.state = {
            year: year,
            month: month,
            inputValue: _this.valuesToMask(month, year),
            showCalendar: false,
        };
        return _this;
    }
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__MonthCalendar__ = __webpack_require__(6);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__OutsideClickWrapper__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Head__ = __webpack_require__(8);
...
var MonthCalendar = /** @class */ (function (_super) {
    ...
    function MonthCalendar(props) {
        ...
        _this.selectYear = function (selectedYear) {
            _this.setState({ selectedYear: selectedYear, currentView: __WEBPACK_IMPORTED_MODULE_3__constants__["a" /* VIEW_MONTHS */] });
        ...
        _this.isYears = function () {
            return _this.state.currentView === __WEBPACK_IMPORTED_MODULE_3__constants__["b" /* VIEW_YEARS */];
        };
    ...
    MonthCalendar.prototype.componentWillReceiveProps = function (nextProps) {
        ...
        if (typeof year == 'number' &&
            ...
            this.setState({
                selectedYear: year,
                selectedMonth: month,
                currentView: __WEBPACK_IMPORTED_MODULE_3__constants__["a" /* VIEW_MONTHS */]
            });
        }
    };
    MonthCalendar.prototype.render = function () {
        ...
        return (__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1__OutsideClickWrapper__["a" /* default */], { onOutsideClick: this.props.onOutsideClick, className: "calendar-container" },
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__Head__["a" /* default */], { year: selectedYear, month: selectedMonth ? selectedMonth + 1 : undefined, lang: this.t.lang, onValueClick: function () { return _this.setState({ currentView: __WEBPACK_IMPORTED_MODULE_3__constants__["b" /* VIEW_YEARS */] }); }, onPrev: this.previous, onNext: this.next }),
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return VIEW_YEARS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return VIEW_MONTHS; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Translator__ = __webpack_require__(2);
...
var valuesFromMask = function (maskedValue) {
    ...
    var year = parseInt(yearVal) < 1000 ? 2000 + parseInt(yearVal) : parseInt(yearVal);
    return [month, year];
};
